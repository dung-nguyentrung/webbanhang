...
@section('title', 'Danh mục con sản phẩm')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Danh mục con sản phẩm</h4>
                </div>
                <div>
                    ...
                    <a href="{{ route('sub_categories.create') }}" class="btn btn-primary add-list"><i
                            class="las la-plus mr-3"></i>Thêm danh mục con</a>
                    @endcan
                </div>
            </div>
        </div>
