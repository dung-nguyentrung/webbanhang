                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="active">
                            <a href="{{ route('dashboard') }}" class="svg-icon">
                                <img src="{{ asset('assets/images/icons/dashboard.png') }}" class="icon-left-bar"
                                    alt="Dashboard">
                        ...
                        <li class=" ">
                            <a href="#product" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                <img src="{{ asset('assets/images/icons/user.png') }}" class="icon-left-bar"
                                    alt="User Management">
                                            ...
                                            <div class="card-body p-0 text-center">
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center mt-3">
                                                        <a href="/" class="btn border mr-2" title="Xem trang chủ"><i
                                                                class="fas fa-home"></i></a>
                                                        <a href="" class="btn border mr-2" title="Hồ sơ của bạn"><i
                                                                class="fas fa-user-circle"></i></a>
                                                        <a href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                                            class="btn border" title="Đăng xuất"><i
